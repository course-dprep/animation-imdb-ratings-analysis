...
As visualised in <graph 2>, the average rating for animation movies is higher (M = 6.509, SD = ) then for non-animation movies (M = 6.218, SD = ). In further solidifying this, the independent t-test found that the difference, 0.291, BCa 95% CI [0.241, 0.341}, is significant t(1973) = 11.417, p = < 0.001.
