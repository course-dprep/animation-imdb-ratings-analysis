...
| Subset        | Number of Observations | Mean Rating | SD Rating | Mean Runtime (minutes) | Mean Number of Votes |
| ------------- | ---------------------- | ----------- | --------- | ---------------------- | -------------------- |
| Animation     | 1,846                  | 6.51        | 1.08      | 90.5                   | 43,393               |
| Non-Animation | 64,051                 | 6.22        | 1.17      | 96.8                   | 30,608               |
| Before 2010   | 20,537                 | 6.29        | 1.14      | 97.0                   | 35,085               |
| Since 2010    | 45,360                 | 6.20        | 1.18      | 96.4                   | 29,101               |




```{r ratings, echo=FALSE}
plot("../gen/output/hist_average.rating.png")
```
...
As visualised in \<graph 2\>, the average rating for animation movies with 6.51 (SD = 1.08) is higher then for non-animation movies with 6.22 (SD = 1.17). In further solidifying this, the independent t-test found that this difference, 0.29, BCa 95% CI [0.241, 0.341}, is significant t(1973) = 11.417, p =\< 0.001. The full output can be consulted in Appendix I. Thus, animation movie
...
With data being created on a daily basis, the analysis of IMDB datasets remains an ongoing process. By repeating this type of research over time it could reveal potential trends in IMDb ratings for animation movies compared to non-animated movies.
